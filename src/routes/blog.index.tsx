...
export const Route = createFileRoute("/blog/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Artigos sobre mentalidade de águia, disciplina, rotina de alta performance e construção de renda na era digital." },
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-6 pt-32 pb-24">
        ...
        <p className="mt-4 max-w-2xl text-muted-foreground">
          Mentalidade, disciplina, estratégia e execução — artigos práticos para transformar visão em resultado na era digital.
        </p>
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {blogPosts.map((post) => (
            ...
            >
              {post.coverImage && (
                <img src={post.coverImage} alt={post.title} className="w-full rounded-lg object-cover max-h-40 mb-4" />
              )}
